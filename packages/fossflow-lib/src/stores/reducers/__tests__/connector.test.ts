  ...
  describe('updateConnector', () => {
    ...
    it('should sync connector when anchors are updated', () => {
      const updates = {
        id: 'connector1',
        anchors: [
          { id: 'anchor1', ref: { item: 'item3' } },
          { id: 'anchor2', ref: { item: 'item4' } }
        ]
      };
    ...
    it('should not sync when anchors are not updated', () => {
      ...
      const updates = {
        id: 'connector1',
        description: 'Just a label update'
      };
  ...
  describe('createConnector', () => {
    it('should create a new connector', () => {
      const newConnector: Connector = {
        id: 'connector2',
        anchors: [
          { id: 'anchor3', ref: { item: 'item5' } },
          { id: 'anchor4', ref: { item: 'item6' } }
        ],
    ...
    it('should create connector with all optional properties', () => {
      ...
      expect(created.lineType).toBe('SINGLE');
