...
describe('rectangle reducer', () => {
  ...
  describe('updateRectangle', () => {
    it('should update rectangle properties', () => {
      ...
      expect(result.model.views[0].rectangles![0].from).toEqual({ x: 5, y: 5 });
      expect(result.model.views[0].rectangles![0].to).toEqual({ x: 205, y: 105 });
    ...
    it('should update color properties', () => {
      const updates = {
        id: 'rect1',
        color: 'color5',
        customColor: '#ff0000'
      ...
      expect(result.model.views[0].rectangles![0].customColor).toBe('#ff0000');
    });
  });
  ...
  describe('createRectangle', () => {
    ...
    it('should create rectangle with all properties', () => {
      ...
      expect(created.from).toEqual({ x: 50, y: 50 });
      expect(created.to).toEqual({ x: 200, y: 125 });
    });
  ...
  describe('edge cases and state immutability', () => {
    ...
    it('should handle rectangles with different coordinate ranges', () => {
      ...
      expect(created.color).toBe('color1');
      expect(created.customColor).toBe('#abc123');
    });
  });
});