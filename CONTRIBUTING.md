...
If you're unsure whether your idea fits, open a [Discussion](https://github.com/MF-swiss/FossFlow/discussions) first.
...
1. Check the [Issues](https://github.com/MF-swiss/FossFlow/issues) page
...
1. **Update your fork**:
   ```bash
   git remote add upstream https://github.com/MF-swiss/FossFlow.git
   git fetch upstream
   git checkout main
...
docker run -p 80:80 mfswiss/fossflow:latest
```
